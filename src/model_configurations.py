...
from function_laplacian_diffusion_ACMP import LaplacianODEFunc as ACMP_LaplacianODEFunc
from function_laplacian_diffusion_GCN import LaplacianODEFunc as GCN_LaplacianODEFunc
...
def set_function(opt):
  ...
  if ode_str == 'laplacian':
    ...
    f = ACMP_LaplacianODEFunc
  elif ode_str == 'GCN':
    f = GCN_LaplacianODEFunc
  elif ode_str == 'GAT':
    f = ODEFuncAtt
